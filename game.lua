...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = self.P_CENTERS or {
        ...
        j_test_joker=       {order = 151,  unlocked = true,  demo = true, discovered = true, blueprint_compat = true, perishable_compat = false, eternal_compat = true, rarity = 1, cost = 1, name = "Test Joker", pos = {x=3,y=6}, set = "Joker", effect = "", config = {extra = 1}, unlock_condition = {type = 'discard_custom'}},
...
function Game:set_render_settings()
    ...
    self.asset_atli = {
        ...
        {name = "Joker", path = "resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/Jokers2.png",px=71,py=95},
        {name = "Test_Joker", path = "resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/Test_Joker.png",px=71,py=95},
        ...
        {name = 'collab_ODN_1', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_ODN_1.png",px=71,py=95},
{name = 'collab_ODN_2', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_ODN_2.png",px=71,py=95},{name = 'collab_TDN_1', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_TDN_1.png",px=71,py=95},
{name = 'collab_TDN_2', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_TDN_2.png",px=71,py=95},{name = 'collab_THDN_1', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_THDN_1.png",px=71,py=95},
{name = 'collab_THDN_2', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_THDN_2.png",px=71,py=95},{name = 'collab_FDN_1', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_FDN_1.png",px=71,py=95},
{name = 'collab_FDN_2', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_FDN_2.png",px=71,py=95},{name = 'collab_SL_1', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_SL_1.png",px=71,py=95},{name = 'collab_SL_2', path ="resources/textures/"..self.SETTINGS.GRAPHICS.texture_scaling.."x/collabs/collab_SL_2.png",px=71,py=95},
